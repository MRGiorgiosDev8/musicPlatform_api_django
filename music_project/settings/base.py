...
SESSION_SHORT_COOKIE_AGE = config(
    "SESSION_SHORT_COOKIE_AGE", cast=int, default=60 * 60 * 12
)
...
SPECTACULAR_SETTINGS = {
    "TITLE": "RubySound API",
    "DESCRIPTION": (
        "API музыкальной платформы: поиск через iTunes, "
        "управление плейлистами и профилями."
    ),
    "VERSION": "1.0.0",
