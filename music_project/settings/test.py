...
This profile keeps PostgreSQL for test DB to validate
JSONField/select_for_update behavior.
"""
...
TEST_DATABASE_URL = config(
    "TEST_DATABASE_URL", default=config("DATABASE_URL", default="")
)
if not TEST_DATABASE_URL:
    raise RuntimeError(
        "TEST_DATABASE_URL or DATABASE_URL must be set to a PostgreSQL URL"
    )
