...
Проект построен на ASGI-архитектуре и включает систему пользователей с JWT-аутентификацией, регистрацией, плейлистами и персональными избранными треками.

**Платформа предоставляет:**
- 🔍 Асинхронный поиск треков (batch-запросы к внешним API)
- 📈 Чарты с возможностью фильтрации по жанрам
- 🎧 Прослушивание превью
- ❤️ Персональные плейлисты (Favorites)
- 🔐 Регистрацию и JWT-аутентификацию пользователей
